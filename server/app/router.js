...
const requireUsernameAndPass = passport.authenticate('local', {failureRedirect: '/unauthenticated', session: false});
...
module.exports = app => {
  ...
  app.post('/test-signin', requireUsernameAndPass, Authentication.signIn);
